...
export const settings = {
  ...
  /** 'single' — работаем с самым крупным скелетом; 'multi' — до 3 человек с пресетами. */
  peopleMode: 'single',
  ...
  gesture: {
    ...
    cooldownMs: 720,
    /** Сколько держать раскрытую ладонь для подтверждения (старт / фото), мс. */
    holdMs: 900,
    /** Сколько кадров жест должен быть стабилен, чтобы считаться распознанным. */
    debounceFrames: 2,
    /** В IDLE: авто-переход в LIVE, если человек стоит перед зеркалом дольше, мс. */
    idleAutoEnterMs: 6000,
  },
